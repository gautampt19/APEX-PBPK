...
init_state <- c(A_gut = 7.5, A_plasma = 0, A_liver = 0, A_metabolized = 0)
...
if (requireNamespace("ggplot2", quietly = TRUE)) {
  ...
  plot(out$time, out$C_plasma, type="l", col="blue", lwd=2, xlab="Time (h)", ylab="Concentration", main="BPS PBPK")
